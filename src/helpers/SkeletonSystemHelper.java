...
public abstract class SkeletonSystemHelper {
    ...
    public static String getSystemProperty(final String property) {
        if (! TextUtils.isEmpty(property)) {
            ...
            if (systemProperty != null) {
                ...
                SkeletonLog.d("SystemProperty was NULL");
            }
        }
        return null;
    }
    ...
    public static String uname() {
        return String.format("%s %s %s",
                SkeletonSystemHelper.getSystemProperty(SkeletonSystemHelper.SYSTEM_PROPERTY_OS_NAME),
                SkeletonSystemHelper.getSystemProperty(SkeletonSystemHelper.SYSTEM_PROPERTY_OS_VERSION),
                SkeletonSystemHelper.getSystemProperty(SkeletonSystemHelper.SYSTEM_PROPERTY_OS_ARCH));
    }
