...
import me.shkschneider.skeleton.android.core.kotlinx.tryOr
import me.shkschneider.skeleton.kotlin.log.ILogger
import me.shkschneider.skeleton.kotlin.log.JvmLogger
...
object Logger : ILogger {
    ...
    init {
        when {
            tryOr({ return@tryOr Class.forName("android.util.Log") != null }, false) == true -> loggers += AndroidLogger
