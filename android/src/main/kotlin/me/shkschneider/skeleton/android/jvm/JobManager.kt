...
import me.shkschneider.skeleton.android.content.componentName
...
open class JobManager(
    ...
    private val builder: JobInfo.Builder = JobInfo.Builder(this.id, componentName(ContextProvider.applicationContext(), cls::class))
