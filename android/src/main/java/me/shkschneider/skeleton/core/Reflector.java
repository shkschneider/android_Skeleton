package me.shkschneider.skeleton.core;
...
public class Reflector {
    ...
    public static class Field {
        ...
        @Nullable
        public static Object field(@NonNull final Object object,
            @NonNull final String declaredField) {
            return field(object.getClass(), declaredField);
        }

        @Nullable
        public static Object field(@NonNull final Class<?> cls,
            @NonNull final String declaredField) {
            try {
        ...
        public static boolean field(@NonNull final Object object,
            @NonNull final String declaredField, final Object value) {
            return field(object.getClass(), declaredField, value);
        }

        public static boolean field(@NonNull final Class<?> cls,
            @NonNull final String declaredField, final Object value) {
            try {
                java.lang.reflect.Field field = cls.getDeclaredField(declaredField);
                field.setAccessible(true);
    ...
    public static class Method {
        ...
        @Nullable
        public static Object method(@NonNull final Object object,
            @NonNull final String declaredMethod, final Class[] signature) {
            return method(object.getClass(), declaredMethod, signature, EMPTY_SIGNATURE);
        }

        @Nullable
        public static Object method(@NonNull final Object object,
            @NonNull final String declaredMethod, final Class[] signature, final Object... params) {
        ...
        @Nullable
        public static Object method(@NonNull final Class<?> cls,
            @NonNull final String declaredMethod, final Class[] signature) {
