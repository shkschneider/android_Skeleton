...
open class DateTime : Comparable<DateTime> {

    constructor(timeInMillis: Long = System.currentTimeMillis()) {
    ...
    override fun toString(): String = calendar.time.toString()
