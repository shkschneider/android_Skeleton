...
public class ActivityHelper {
    ...
    public static boolean toast(@NonNull final String message) {
        Toast.makeText(SkeletonApplication.CONTEXT, message, Toast.LENGTH_SHORT).show();
        return true;
    }

    public static boolean popup(@NonNull final Activity activity, final String title, @NonNull final String message,
    ...
    public static boolean fromLauncher(@NonNull final Activity activity) {
