...
public class SkeletonEventController {
    ...
    public void bind(@NotNull final String event, @NotNull final Receiver receiver) {
    ...
    public void unbind(@NotNull final String event, @NotNull final Receiver receiver) {
        if (! MapHelper.keys(mReceivers).contains(event)) {
    ...
    public List<String> events(@NotNull final Receiver receiver) {
    ...
    public void notify(@NotNull final SkeletonEvent skeletonEvent) {
