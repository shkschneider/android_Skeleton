...
public class IntentHelper {
    ...
    public static boolean canHandle(@NotNull final Intent intent) {
    ...
    public static boolean home(@NotNull final Activity activity, @NotNull final Class cls) {
    ...
    public static boolean web(@NotNull final Activity activity, @NotNull final String url) {
    ...
    public static boolean market(@NotNull final Activity activity, @NotNull final String pkg) {
    ...
    public static boolean market(@NotNull final Activity activity) {
        final Intent intent = new Intent(Intent.ACTION_VIEW);
    ...
    public static boolean email(@NotNull final Activity activity, @NotNull final String[] to, final String subject, final String text) {
    ...
    public static boolean image(@NotNull final Activity activity, @NotNull final Uri uri) {
    ...
    public static boolean camera(@NotNull final Activity activity) {
    ...
    public static boolean gallery(@NotNull final Activity activity) {
    ...
    public static Bitmap onActivityResult(final int requestCode, final int resultCode, @NotNull final Intent intent) {
