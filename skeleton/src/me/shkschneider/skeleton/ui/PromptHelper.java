...
public class PromptHelper {
    ...
    public static boolean date(@NotNull final Activity activity, @NotNull final Callback callback) {
    ...
    public static boolean time(@NotNull final Activity activity, @NotNull final Callback callback) {
    ...
    public static boolean string(@NotNull final Activity activity, @NotNull final String title, @NotNull final Callback callback) {
    ...
    public static boolean number(@NotNull final Activity activity, @NotNull final String title, final int min, final int value, final int max, @NotNull final Callback callback) {
        if (min < 0 || min >= max) {
    ...
    public static boolean number(@NotNull final Activity activity, @NotNull final String title, final int min, final int max, @NotNull final Callback callback) {
        return number(activity, title, min, 0, max, callback);
    }

    public static boolean choice(@NotNull final Activity activity, @NotNull final String title, @NotNull final String[] choices, int checked, @NotNull final Callback callback) {
    ...
    public static boolean choice(@NotNull final Activity activity, @NotNull final String title, @NotNull final String[] choices, @NotNull final Callback callback) {
